package br.com.totvs.zeus.api.model.dataquery;

public class ZeusDataQuery {

	public static final String USUARIO_POR_LOGIN = " select new br.com.totvs.zeus.api.model.response.UsuarioWSResponse("
